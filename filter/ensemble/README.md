...
### <a id="zip_install"></a>Installing from ZIP
    ...
    $ wget https://github.com/ensembleVideo/moodle-filter_ensemble/archive/MOODLE_34_STABLE.zip
    $ unzip MOODLE_34_STABLE.zip
    $ mv moodle-filter_ensemble-MOODLE_34_STABLE /path/to/your/moodle/filter/ensemble
