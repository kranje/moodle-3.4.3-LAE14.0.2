...
for [installing contributed extensions via Git](http://docs.moodle.org/34/en/Git_for_Administrators#Installing_a_contributed_extension_from_its_Git_repository).
...
### <a id="zip_install"></a>Installing from ZIP
    ...
    $ wget https://github.com/ensembleVideo/moodle-repository_ensemble/archive/MOODLE_34_STABLE.zip
    $ unzip MOODLE_34_STABLE.zip
    $ mv moodle-repository_ensemble-MOODLE_34_STABLE /path/to/your/moodle/repository/ensemble
...
<a href="https://docs.moodle.org/34/en/Managing_roles">modify access</a> to the
