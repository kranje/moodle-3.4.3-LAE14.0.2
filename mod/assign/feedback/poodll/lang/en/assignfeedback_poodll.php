...
/**
 * Strings for component 'assignfeedback_poodll', language 'en'
 *
...
$string['replyvoice'] = 'Voice Recorder (Red5)'; //defunct .. can be removed
...
$string['downloadsok'] = 'Show download link';
